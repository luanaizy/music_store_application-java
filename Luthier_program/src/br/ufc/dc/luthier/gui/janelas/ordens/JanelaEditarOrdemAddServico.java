...
import br.ufc.dc.luthier.gui.listeners.ordens.BotaoEditarOrdemActionAddServicoConsertoListener;
import br.ufc.dc.luthier.gui.listeners.ordens.BotaoEditarOrdemActionAddServicoConstrucaoListener;
import br.ufc.dc.luthier.gui.listeners.ordens.BotaoEditarOrdemActionAddServicoRegulagemListener;
import br.ufc.dc.luthier.gui.listeners.ordens.BotaoEditarOrdemActionAddServicoRevisaoListener;
import br.ufc.dc.luthier.gui.listeners.ordens.BotaoEditarOrdemActionAddServicoTrocaDePecaListener;
import br.ufc.dc.luthier.gui.listeners.ordens.ComboboxEditarOrdemAddServicoListener;
...
public class JanelaEditarOrdemAddServico extends JFrame {
	public JanelaEditarOrdemAddServico(JanelaOrdensDeServico owner,int index,JanelaEditarOrdem owner_cadastro,Vector<ServicoAbstract> servicos,
			Vector<Material> materiais, Vector<Notificacao> notificacoes, String servico_selecionado, ClienteController cliente_controller,
		...
		tipo_servico_input.addActionListener(new ComboboxEditarOrdemAddServicoListener( owner,index, owner_cadastro, servicos, materiais, notificacoes,tipo_servico_input, 
		...
		if(servico_selecionado.equals("MANUTENCAO - CONSERTO")) {
			...
			adicionar_button.addActionListener(new BotaoEditarOrdemActionAddServicoConsertoListener(owner,index,owner_cadastro,servicos,materiais,notificacoes, valor_input, descricao_input,adicional_input,
					  cliente_controller,  funcionario_controller, instrumento_controller,  material_controller,   ordem_controller));
			...
			JButton adicionar_button = new JButton("Adicionar");
			adicionar_button.addActionListener(new BotaoEditarOrdemActionAddServicoRegulagemListener(owner,index,owner_cadastro,servicos,materiais,notificacoes, valor_input, descricao_input,adicional_input,
					  cliente_controller,  funcionario_controller, instrumento_controller,  material_controller,   ordem_controller));
			adicionar_button.setAlignmentX(Component.CENTER_ALIGNMENT);
			...
			JButton adicionar_button = new JButton("Adicionar");
			adicionar_button.addActionListener(new BotaoEditarOrdemActionAddServicoTrocaDePecaListener(owner,index,owner_cadastro,servicos, materiais,notificacoes,valor_input, descricao_input,adicional_input,
					  cliente_controller,  funcionario_controller, instrumento_controller,  material_controller,   ordem_controller));
			adicionar_button.setAlignmentX(Component.CENTER_ALIGNMENT);
			...
			JButton adicionar_button = new JButton("Adicionar");
			adicionar_button.addActionListener(new BotaoEditarOrdemActionAddServicoRevisaoListener(owner,index,owner_cadastro,servicos, materiais,notificacoes,valor_input, descricao_input,adicional_input,
			...
			JButton adicionar_button = new JButton("Adicionar");
			adicionar_button.setAlignmentX(Component.CENTER_ALIGNMENT);
			adicionar_button.addActionListener(new BotaoEditarOrdemActionAddServicoConstrucaoListener(owner,index,owner_cadastro,servicos, materiais,notificacoes,valor_input, descricao_input,
					  cliente_controller,  funcionario_controller, instrumento_controller,  material_controller,   ordem_controller));
