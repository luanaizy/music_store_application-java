...
public class BotaoEditarOrdemActionAddServicoConsertoListener implements ActionListener {
	private int index;
	...
	public BotaoEditarOrdemActionAddServicoConsertoListener( JanelaOrdensDeServico owner,int index,JanelaEditarOrdem owner_cadastro,Vector<ServicoAbstract> servicos,
			Vector<Material> materiais, Vector<Notificacao> notificacoes,
			JTextArea valor_input, JTextArea descricao_input, JTextArea adicional_input,
	...
	public void actionPerformed(ActionEvent e) {
		servicos.add(new ServicoManutencaoConserto(descricao_input.getText(), 
