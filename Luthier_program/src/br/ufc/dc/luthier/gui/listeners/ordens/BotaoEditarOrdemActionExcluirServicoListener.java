...
public class BotaoEditarOrdemActionExcluirServicoListener implements ActionListener {
	private int index;
	...
	public BotaoEditarOrdemActionExcluirServicoListener(int index,int index_ordem, JanelaOrdensDeServico owner, JanelaEditarOrdem owner_cadastro,
