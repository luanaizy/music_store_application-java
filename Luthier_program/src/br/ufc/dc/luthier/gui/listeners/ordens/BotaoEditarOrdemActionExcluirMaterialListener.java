...
public class BotaoEditarOrdemActionExcluirMaterialListener implements ActionListener {
	private int index;
	...
	public BotaoEditarOrdemActionExcluirMaterialListener(int index,int index_ordem, JanelaOrdensDeServico owner, JanelaEditarOrdem owner_cadastro,
