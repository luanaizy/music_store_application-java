...
public class BotaoEditarOrdemActionAddServicoConstrucaoListener  implements ActionListener {
	private int index;
	...
	public BotaoEditarOrdemActionAddServicoConstrucaoListener( JanelaOrdensDeServico owner,int index,JanelaEditarOrdem owner_cadastro,Vector<ServicoAbstract> servicos,
			Vector<Material> materiais, Vector<Notificacao> notificacoes,
			JTextArea valor_input, JTextArea descricao_input, 
