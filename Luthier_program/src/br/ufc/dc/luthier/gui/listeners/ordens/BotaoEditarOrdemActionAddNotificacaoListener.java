...
public class BotaoEditarOrdemActionAddNotificacaoListener implements ActionListener {
	private JTextArea notificacao_input;
	...
	public BotaoEditarOrdemActionAddNotificacaoListener(JTextArea notificacao_input, JanelaOrdensDeServico owner,int index_ordem, JanelaEditarOrdem owner_cadastro,
		...
		this.notificacao_input = notificacao_input;
		this.owner = owner;
	...
	public void actionPerformed(ActionEvent e) {
			...
			notificacoes.add(new Notificacao(notificacao_input.getText()));
