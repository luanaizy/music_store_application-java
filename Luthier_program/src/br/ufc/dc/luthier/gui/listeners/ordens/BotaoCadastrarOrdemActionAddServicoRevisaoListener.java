...
public class BotaoCadastrarOrdemActionAddServicoRevisaoListener implements ActionListener {
	...
	public BotaoCadastrarOrdemActionAddServicoRevisaoListener( JanelaOrdensDeServico owner,JanelaCadastrarOrdem owner_cadastro,Vector<ServicoAbstract> servicos,
			JTextArea valor_input, JTextArea descricao_input, JTextArea adicional_input, JComboBox<String>tipo_servico_recomendado_input, 
