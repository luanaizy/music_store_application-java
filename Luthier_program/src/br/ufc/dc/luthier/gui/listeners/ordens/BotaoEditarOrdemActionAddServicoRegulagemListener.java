...
public class BotaoEditarOrdemActionAddServicoRegulagemListener implements ActionListener {
	private int index;
	...
	public BotaoEditarOrdemActionAddServicoRegulagemListener( JanelaOrdensDeServico owner,int index,JanelaEditarOrdem owner_cadastro,Vector<ServicoAbstract> servicos,
